...
//		String eworkDate = (String) map.get("eworkDate");
		...
		return debtYinTuanService.queryAuditYinTuan("signed", pageIndex, pageSize, qStartDate, qEndDate, qactiontype, qRecStatus, qapproveStatus, qrepStatus, qfiller2);
//		return debtYinTuanService.queryAuditYinTuan("signed", pageIndex, pageSize, qworkDate, eworkDate, qactiontype, qRecStatus, qapproveStatus, qrepStatus, qfiller2);
	}
}
