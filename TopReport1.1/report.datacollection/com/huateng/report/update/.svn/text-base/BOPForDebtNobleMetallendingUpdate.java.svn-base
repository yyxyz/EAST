		...
		if(updateResultBean.hasNext())
		{
			...
			if(!StringUtils.isEmpty(op))
			{
				if(RECORD_ADD.equalsIgnoreCase(op))
				{
					...
					oc.setAttribute(BOPForDebtNobleMetalLendingOperation.CMD, BOPForDebtNobleMetalLendingOperation.CMD_INSERT);
				}
				else if(RECORD_MOD.equalsIgnoreCase(op))
				{
					...
					oc.setAttribute(BOPForDebtNobleMetalLendingOperation.CMD, BOPForDebtNobleMetalLendingOperation.CMD_UPDATE);
				}
				else if(RECORD_DELETE.equalsIgnoreCase(op))
				{
					...
					*/
					...
					oc.setAttribute(BOPForDebtNobleMetalLendingOperation.CMD, BOPForDebtNobleMetalLendingOperation.CMD_DELETE);
				}
			}
		}
