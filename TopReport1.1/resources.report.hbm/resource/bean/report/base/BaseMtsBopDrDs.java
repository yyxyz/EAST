...
/**
 * This is an object that contains data related to the MTS_BOP_Dr_DS table.
...
public abstract class BaseMtsBopDrDs  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof resource.bean.report.MtsBopDrDs)) return false;
		else {
			resource.bean.report.MtsBopDrDs mtsBopDrDs = (resource.bean.report.MtsBopDrDs) obj;
			if (null == this.getId() || null == mtsBopDrDs.getId()) return false;
			else return (this.getId().equals(mtsBopDrDs.getId()));
		}
	}
