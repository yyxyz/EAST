...
/**
 * This is an object that contains data related to the MTS_BOP_CKP_DS table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="MTS_BOP_CKP_DS"
 */
...
public abstract class BaseMtsBopCkpDs  implements Serializable {
	 ...
	 * @param custype the CUSTYPE value
	 */
	 ...
	 * @param custcod the CUSTCOD value
	 */
	 ...
	 * @param oppuser the OPPUSER value
	 */
	 ...
	 * @param buscode the BUSCODE value
	 */
	 ...
	 * @param actuccy the ACTUCCY value
	 */
	 ...
	 * @param actuamt the ACTUAMT value
	 */
	 ...
	 * @param outchargeccy the OUTCHARGECCY value
	 */
	 ...
	 * @param outchargeamt the OUTCHARGEAMT value
	 */
	 ...
	 * @param issdate the ISSDATE value
	 */
	 ...
	 * @param txcode2 the TXCODE2 value
	 */
	 ...
	 * @param crtuser the CRTUSER value
	 */
	 ...
	 * @param inptelc the INPTELC value
	 */
	 ...
	 * @param rptdate the RPTDATE value
	 */
	 ...
	 * @param impdate the IMPDATE value
	 */
	 ...
	 * @param contrno the CONTRNO value
	 */
	 ...
	 * @param invoino the INVOINO value
	 */
	 ...
	 * @param contamt the CONTAMT value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof resource.bean.report.MtsBopCkpDs)) return false;
		else {
			resource.bean.report.MtsBopCkpDs mtsBopCkpDs = (resource.bean.report.MtsBopCkpDs) obj;
			if (null == this.getId() || null == mtsBopCkpDs.getId()) return false;
			else return (this.getId().equals(mtsBopCkpDs.getId()));
		}
	}
