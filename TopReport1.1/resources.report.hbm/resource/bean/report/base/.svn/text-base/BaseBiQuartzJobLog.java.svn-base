...
public abstract class BaseBiQuartzJobLog  implements Serializable {
	 ...
	 * @param quartzId the QUARTZ_ID value
	 */
	 ...
	 * @param execTm the EXEC_TM value
	 */
	 ...
	 * @param quartzName the QUARTZ_NAME value
	 */
	 ...
	 * @param quartzResult the QUARTZ_RESULT value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof resource.bean.report.BiQuartzJobLog)) return false;
		else {
			resource.bean.report.BiQuartzJobLog biQuartzJobLog = (resource.bean.report.BiQuartzJobLog) obj;
			if (null == this.getId() || null == biQuartzJobLog.getId()) return false;
			else return (this.getId().equals(biQuartzJobLog.getId()));
		}
	}
