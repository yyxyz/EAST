...
public class BOPForDebtAndSubSidQueryChangeGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws CommonException, IllegalAccessException, InvocationTargetException{
		...
		return debtYinTuanService.queryFeiOrgSaveQuery("overs", pageIndex, pageSize, qbrNo, qrecStatus, qactiontype, qapproveStatus, qrepStatus, qfiller2, qworkDate,eworkDate);
	}
}
