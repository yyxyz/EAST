 ...
 * @version $Id: ViewerFrame.java,v 1.10 2006/04/19 10:27:11 teodord Exp $
 */
public class ViewerFrame extends javax.swing.JFrame implements JRHyperlinkListener
{
	 ...
	 *
	 */
	public ViewerFrame(AppletContext appletContext,List viewList, List jasperPrintList,boolean isURL) throws JRException
	{
		initComponents();

		this.appletContext = appletContext;
		
		JRListViewer viewer = new JRListViewer(viewList,jasperPrintList,isURL);
