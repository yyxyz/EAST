...
public class BopEDsAuditGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws AppException {
		...
		return bopEqDsAuditService.queryBOPEqAudit(TopReportConstants.REPORT_FILE_TYPE_BOP_E, pageIndex, pageSize, qworkDateStart, qworkDateEnd, qactiontype, qrecStatus, qapproveStatus, qrepStatus, qfiller2);
	}
}