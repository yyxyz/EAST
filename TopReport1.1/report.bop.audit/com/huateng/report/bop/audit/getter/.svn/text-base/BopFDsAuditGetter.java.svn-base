...
public class BopFDsAuditGetter extends BaseGetter {
	...
	private PageQueryResult getData() throws CommonException {
	    ...
	    return bopFsDsService.queryBopFsAudit(TopReportConstants.REPORT_FILE_TYPE_BOP_F, pageIndex, pageSize, qworkDateStart, qworkDateEnd, qactiontype, qrecStatus, qapproveStatus, qrepStatus, qfiller2);
	}
}