...
public class BopForSameInduDepositLoadPageGetter extends BaseGetter{
	...
	private PageQueryResult getData() throws CommonException{
		...
		//	hql.append("    FROM BopCfaExdebtDs bds LEFT JOIN BopCfaCreditorDs bcd ON bds.id = bcd.recId WHERE 1 = 1 ");
		   ...
		   hql.append(" and  (bds.rec_Status ='"+TopReportConstants.REPORT_RECSTATUS_01+"' or  bds.rec_Status='"+TopReportConstants.REPORT_RECSTATUS_02+"')");
		   hql.append(" and (bds.actiontype ='"+TopReportConstants.REPORT_ACTIONTYPE_A+"' or bds.actiontype ='"+TopReportConstants.REPORT_ACTIONTYPE_C+"' )");
