...
public class ReportTaskUtil {
	...
	private static String getTaskNo() throws CommonException{
			GetSysTaskNoGentator getSysTaskNoGentator = (GetSysTaskNoGentator) GeneratorFactory.getGenerator("GetSysTaskNoGentator");
	...
	/**
	 * 获取写入复核任务表Bean
	 * @param intInsId 审计功能码
	 * @param updTransCd 变更功能码
	 * @param obj 对象 （可以为空）
	 * @param objId 对象主键（可以为空）
	 * @param oldSt 原记录状态，用于审计不通过恢复状态 (创建时可以为空)
	 * @return
	 * @throws CommonException
	 * @throws IOException
	 * @throws IOException
	 * @throws IOException
	 */
	public static SysTaskInfo getSysTaskInfoBean(String intInsId,String updTransCd,Object obj,String objId,String oldSt) throws CommonException, IOException{
...
//	 * @throws CommonException
//	 */
//	public TblGcmsAdtTskInf getTblGcmsAdtTskInfBeanByEdit(TblGcmsAdtTskInf oldAdtTskInf,String updTransCd,Object newObj,String newObjId) throws CommonException{
//		GlobalInfo gd = GlobalInfo.getCurrentInstance();
//		String crtDt = DateUtil.get8Date();
//		String lastTms = DateUtil.get14Date();
...
//		if (newObj!=null) {
//			String[] jsons =  GcmsJsonUtil.getStrToArray(GcmsJsonUtil.ObjectToString(newObj));
//
...
//	}
	 ...
	 * @throws IOException
	 */
	public static Object getObjctBySysTaskInfo(SysTaskInfo tskInf) throws CommonException, IOException, ClassNotFoundException{
		Object obj = null;
		if (tskInf!=null) {
	 ...
	 * @throws IOException
	 */
	public static Object getOldObjectByTaskLog(SysTaskLog tskInf) throws CommonException, IOException, ClassNotFoundException{
		Object obj = null;
		if (tskInf!=null) {
			StringBuffer result = new StringBuffer();
	...
	//获取日志表中的新值
	public static Object getNewObjectByTaskLog(SysTaskLog tsklog) throws CommonException, IOException, ClassNotFoundException{
		Object obj = null;
		if (tsklog!=null) {
			StringBuffer result = new StringBuffer();
