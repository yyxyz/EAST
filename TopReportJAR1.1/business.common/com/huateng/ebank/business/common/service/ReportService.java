...
public class ReportService {
    ...
    public String getReport(String brcode, Date reportDate, String fileBase)
            throws CommonException {
        FTPClientHelper helper = (FTPClientHelper) ApplicationContextUtils
                .getBean("report.ftp");
        String strDate = DataFormat.dateToNumber(reportDate);
     ...
     * @param fileBase      基础文件名
     * @throws CommonException
     */
    public String[] downloadFile(String brcode, Date reportDate, String fileBase)
            throws CommonException {
        File file = null;
        ...
        fileName.append(brcode).append("-").append(strDate).append("-").append(
                fileBase);
